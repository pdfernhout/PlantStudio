...
def Plant_directTransferField_SecondPart(plantProxy, v, d, fieldID, ft, index, updateList):
    ...
    if fieldID == kFlowerMaleObject3D:
        ...
        return Plant_directTransferField_SecondPart2(plant, v, d, fieldID, ft, index, updateList)
    return v
        
def Plant_directTransferField_SecondPart2(plant, v, d, fieldID, ft, index, updateList):
    if fieldID == kFlowerMaleBudOption:
