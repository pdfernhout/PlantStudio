    ...
    def readLineAndTdoFromPlantFile(self, aLine, plantFile):   
        ...
        if (not string_match("[", aLine, find=1)) or (not string_match("=", aLine, find=1)):
            if self.readingFromMemo:
                ...
                raise "not here before -- PORT ISSUE"
                secondLine = readln(plantFile)
        ...
        try:
            ...
            while aLine != None:
                ...
                if string_startsWith("offset=", aLine):
                    ...
                    lineCount = 0
                    aLine = readln(inputFile)
                    while (aLine != None) and (not string_match(kPlantAsTextEndString, aLine)) and (lineCount <= 3000):
                        # aLine <> '' do
                        if aLine == None:
                            break
