...
class PdFlowerFruit(upart.PdPlantPart):
    def __init__(self):
        ...
        if (self.plant.pFlower[self.gender].numPistils > 0):
            ...
            for i in range(0, self.plant.pFlower[self.gender].numPistils):
                ...
                if (self.plant.pFlower[self.gender].styleLength_mm > 0) and (self.plant.pFlower[self.gender].styleWidth_mm > 0):
                    ...
                    self.drawStemSegment(length, width, angle, 0, self.plant.pFlower[self.gender].styleColor, self.plant.pFlower[self.gender].styleTaperIndex, self.dxfIndexForFloralLayerType(uplant.kPistils, kLine), upart.kDontUseAmendment)
        ...
        if self.plant.pFlower[self.gender].numStamens > 0:
            ...
            for i in range(0, self.plant.pFlower[self.gender].numStamens):
                ...
                if (self.plant.pFlower[self.gender].filamentLength_mm > 0) and (self.plant.pFlower[self.gender].filamentWidth_mm > 0):
                    ...
                    if drawAsOpening:
                        angle = angle * self.propFullSize
                    self.drawStemSegment(length, width, angle, 0, self.plant.pFlower[self.gender].filamentColor, self.plant.pFlower[self.gender].filamentTaperIndex, self.dxfIndexForFloralLayerType(uplant.kStamens, kLine), upart.kDontUseAmendment)
        ...
        if self.stage == uplant.kStageFlowerBud:
            if self.plant.pFlower[self.gender].budDrawingOption == uplant.kDrawNoBud:
                ...
                if self.plant.pFlower[self.gender].tdoParams[uplant.kBud].scaleAtFullSize > 0:
                    ...
                    traverser.total3DExportTrianglesIn3DObjects += len(self.plant.pFlower[self.gender].tdoParams[uplant.kBud].object3D.triangles) * self.plant.pFlower[self.gender].tdoParams[uplant.kBud].repetitions
