...
class PdPlantPart(PdStreamableObject):
    def __init__(self):
        self.plant = PdPlant()
        ...
        self.parentAmendment = PdPlantDrawingAmendment()
    ...
    def drawStemSegment(self, length, width, angleZ, angleY, color, taperIndex, dxfIndex, useAmendment):
        ...
        realLength = len * self.lengthMultiplierConsideringAmendments()
