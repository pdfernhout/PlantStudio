...
class FileExport3DOptionsStructure:
    def __init__(self):
        ...
        self.dxf_plantPartColorIndexes = [0] * (kExportPartLast + 1)
...
class KfFileExportSurface(udrawingsurface.KfDrawingSurface):
    def __init__(self):
        self.fileName = ""
        self.scale = 0.0
        ...
        self.currentColor = UnassignedColor
...
class KfDrawingSurfaceFor3DS(KfBinaryFileExportSurface):
    ...
    def popChunkStartAndFixupChunkSize(self):
        ...
        startSize = self.chunkStartStack[lastIndex]
